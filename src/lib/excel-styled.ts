...
export async function buildStyledWorkbook(data: FullDataSet): Promise<ExcelJS.Workbook> {
  ...
  if (data.rentRoll.length > 0) {
    addStyledSheet(wb, 'Rent Roll', [
      ...
      { header: 'Base Rent ($/SF)', key: 'startingAnnualRentPSF', width: 16, style: CURRENCY_STYLE },
      { header: 'Annual Escalation %', key: 'annualRentBumpsPct', width: 18, style: PCT_STYLE },
      ...
      { header: 'In-Place Rent', key: 'inPlaceRent', width: 14, style: CURRENCY_STYLE },
      { header: 'Lease Term (Mo)', key: 'leaseTermMonths', width: 14, style: INT_STYLE },
      { header: 'Notes', key: 'notes', width: 40 },
      { header: 'ID', key: 'id', width: 38 },
      ...
      leaseEnd: r.leaseEnd,
      startingAnnualRentPSF: r.startingAnnualRentPSF,
      annualRentBumpsPct: frac(r.annualRentBumpsPct),
  ...
  if (data.onboardings.length > 0) {
    ...
    addStyledSheet(wb, 'Onboarding', [
      ...
      { header: 'Rent Roll ID', key: 'rentRollId', width: 38 },
      { header: 'Template Version', key: 'templateVersion', width: 16 },
  ...
  if (data.buildings.length > 0) {
    addStyledSheet(wb, 'Buildings', [
      ...
      { header: 'Lat', key: 'centerLat', width: 12 },
      { header: 'Lng', key: 'centerLng', width: 12 },
      { header: 'Rotation (°)', key: 'rotationDeg', width: 12 },
  ...
  if (data.devProjects.length > 0) {
    addStyledSheet(wb, 'Dev Projects', [
      ...
      { header: 'Market', key: 'market', width: 16 },
      { header: 'Acres', key: 'acres', width: 10, style: NUMBER_STYLE },
      { header: 'Total SF', key: 'totalSF', width: 12, style: NUMBER_STYLE },
      { header: 'Building Count', key: 'buildingCount', width: 14, style: INT_STYLE },
      { header: 'Total Budget', key: 'totalBudget', width: 16, style: CURRENCY_STYLE },
      { header: 'Spent to Date', key: 'spentToDate', width: 14, style: CURRENCY_STYLE },
  ...
  if (data.propertyTaxAppeals.length > 0) {
    addStyledSheet(wb, 'Tax Appeals', [
      ...
      ourProposedValue: a.proposedValue,
      settledValue: a.finalAssessedValue,
      status: a.status,
      filingDeadline: a.filedDate,
  ...
  if (data.devProjectNotes.length > 0) {
    addStyledSheet(wb, 'Dev Project Notes', [
      ...
      title: '', content: n.content, author: n.author,
  ...
  if (data.acquisitionTargets.length > 0) {
    addStyledSheet(wb, 'Acquisitions', [
      ...
      buildingSF: a.totalSF, landAcres: a.acres,
      askingPrice: a.askingPrice, ourOffer: a.ourOffer,
      underwrittenIRR: frac(a.underwrittenIRR), underwrittenYield: frac(a.underwrittenEquityMultiple),
      broker: '', seller: '',
  ...
  if (data.dispositionListings.length > 0) {
    addStyledSheet(wb, 'Dispositions', [
      ...
      buildingSF: d.totalSF, landAcres: d.acres,
      listPrice: d.listPrice, listCapPct: frac(d.listCapPct),
      noi: d.trailingNOI, occupancyPct: frac(d.occupancyPct),
      broker: '', lat: d.lat, lng: d.lng, notes: d.notes,
